...
DEF_UNAPPROVED_MSG = (
    f"╭━━━━━━━━━━━━━━━━━╮\n    ✘HI TOD LU MAU APA SOMBONG SKIP✘\n"
    "╰━━━━━━━━━━━━━━━━━╯\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"ANAK KONTOL ANAK NGENTOT,KALO NGECHAT MAJIKAN {rambot} ITU SALAM,\nHABIS ITU SABAR TUNGGU MAJIKAN GUA BALES,\nKALO GA DI BALES - BALES, SADAR DIRI MUNGKIN LU JELEK, LU SOMBONG ATAU LU SI PALING DI ATAS...CANDA BANG🗿JANGAN NYEPAM YA KONTOL, KAYA ANAK YATIM MAU MINTA SEMBAKO LU ANJING, APA LAGI LU NGECHAT NYA CUMA MINTA MINTA TERUS UDAH DAPAT KABUR, NGILANG KEK ARTIS LUPA UDAH KEBAIKAN... HARGAILAH ANJ, BISA GUA BLOKIR!! KALO NYEPAM JUGA TAR GUA BLOKIR!!!! TUNGGU SI {rambot} NERIMA PESAN LU YA TOD\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 ✫AM͢͢͢ITOD-฿OT\n"
    ...
    if (
        ...
        if not apprv and event.text != UNAPPROVED_MSG:
            ...
            if COUNT_PM[event.chat_id] > LMT_PM:
                await event.respond(
                    f"**Dih Najis Kerana Lu Spam, Lu Udah Di Block Sama Assistant {rambot}**"
                )
                ...
                try:
                    ...
                    if BOTLOG_CHATID:
                        await event.client.send_message(
                            BOTLOG_CHATID,
                            "**Awokwowk Kasian Lu Tod Terjadi Error Saat Menghitung Private Message, Mohon Restart Bot Ya Tod!**",
                        )
                    return LOGS.info("Lu Jelek Jadi Gagal Menghitung PM Yang Diterima")
                ...
                if BOTLOG_CHATID:
                    ...
                    await event.client.send_message(
                        ...
                        + str(event.chat_id)
                        + ")"
                        + " **Awowkwok Kasian..Lu Telah Diblokir Karna Melakukan Spam Ke Room Chat Makanya Ganteng KONTOL**",
                    )
...
async def approvepm(apprvpm):
    ...
    if apprvpm.reply_to_msg_id:
        ...
        if not isinstance(user, User):
            return await edit_delete(
                apprvpm, "**Woy Tod Mohon Reply Pesan User Yang Ingin Diterima.**"
            )
    ...
    try:
        ...
        return await edit_delete(apprvpm, "**Awokwowk Kerana Kasian Pesan Lu Udah Diterima Ya Tod**")

    await edit_delete(
        apprvpm, f"**Oke Tod Menerima Pesan Dari** [{name0}](tg://user?id={uid})", 5
    )
...
async def disapprovepm(disapprvpm):
    ...
    if disapprvpm.reply_to_msg_id:
        ...
        try:
            ...
            return await edit_delete(
                disapprvpm, "**Woy Tod Mohon Reply Pesan User Yang ingin ditolak.**"
            )
    ...
    await edit_or_reply(
        disapprvpm,
        f" **Maaf Ya Tod** [{name0}](tg://user?id={aname}) **Lu Terlalu Jelek Jadi Gw Tolak Pesan Lu, Mohon Jangan Melakukan Spam Ya Tod Di Room Chat Gw!**",
    )
...
async def blockpm(block):
    ...
    if block.reply_to_msg_id:
        ...
        await block.edit("**Dih Najis Lu Terlalu Sombong Lu Gw Block Aja GakAdaGunanya BERTEMAN!**")
        uid = replied_user.id
    else:
...
async def unblockpm(unblock):
    ...
    if unblock.reply_to_msg_id:
        ...
        await unblock.edit("**Oke Udah Gua Unblock Lu Ya Tod, Makanya Gak Usah SombongLu Najis.**")
